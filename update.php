...
if (isset($_POST["btnUpdate"])) {
	...
	// if patrol car status is Arrived (4) than capture the time of arrival
    ...
    }  else if ($_POST["patrolCarStatus"] == '3'){ // else if patrol car status is FREE (3) than capture the time of completion
...
{ // post back here after clicking the btnSearch button
  ...
  $patrolCarStatusArray;; // an array variale
  ...
  <form name="form2" method="post" action="<?php echo htmlentities($_SERVER['PHP_SELF']); ?> ">
    ...
    <table width="20%" border="0" align="center" cellpadding="4" cellspacing="4">
	    <tr></tr>
	    <tr>
		    <td>ID :</td>
