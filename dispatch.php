...
<?php //if post back
	if (isset($_POST["btnDispatch"]))
	{
	 ...
	 <fieldset>
		 <br>
<center><legend><strong>Dispatch Patrol Cars</strong></legend></center>
		 <br>
...
<table width="40%" border="1" align="center" cellpadding="4" cellspacing="4">
	...
	<tr>
	<td>Description:</td>                                                                                                       <td><textarea name="incidentDesc" cols="45" rows="5" readonly id="incidentDesc"><?php echo $_POST['incidentDesc']?></textarea>
